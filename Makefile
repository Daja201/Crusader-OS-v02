...
# files
ASM = loader.s
C_SRC = kernel.c vga.c klog.c bioskbd.c terminal.c commands.c string.c reboot.c fs.c diskinfo.c runtest.c library.c libdiv.c rtc.c
OBJ = loader.o kernel.o vga.o klog.o bioskbd.o terminal.o commands.o string.o reboot.o fs.o diskinfo.o runtest.o library.o libdiv.o rtc.o
ISO_DIR = iso
